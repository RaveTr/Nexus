 ...
 */
public interface DataGenPropertyWrapperBuilder<T, SELF extends PropertyWrapperBuilder<T, SELF, DGPW>, DGPW extends PropertyWrapper<T, DGPW, SELF>> extends PropertyWrapperBuilder<T, SELF, DGPW> {
