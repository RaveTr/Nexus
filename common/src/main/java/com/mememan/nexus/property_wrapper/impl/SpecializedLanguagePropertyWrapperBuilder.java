...
public class SpecializedLanguagePropertyWrapperBuilder<T, SELF extends LanguageBasedPropertyWrapperBuilder<T, SELF, LPW>, LPW extends LanguageBasedPropertyWrapper<T, LPW, SELF>> extends BaseDataGenPropertyWrapperBuilder<T, SELF, LPW> implements LanguageBasedPropertyWrapperBuilder<T, SELF, LPW> {
    ...
    public SpecializedLanguagePropertyWrapperBuilder(@NotNull LPW ownerWrapper) {
        super(ownerWrapper);
    }

    @Override
    public SELF copyFrom(LPW propertyWrapper) {
