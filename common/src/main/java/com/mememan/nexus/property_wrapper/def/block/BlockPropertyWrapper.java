...
public class BlockPropertyWrapper<B extends Block> extends BaseDataGenPropertyWrapper<B, BlockPropertyWrapper<B>, BlockPropertyWrapperBuilder<B>> implements DefaultableDataGenPropertyWrapper<B, BlockPropertyWrapper<B>, BlockPropertyWrapperBuilder<B>> {
    ...
    public BlockPropertyWrapper(Supplier<B> parentObject, boolean isTemplate, Function<BlockPropertyWrapper<B>, PropertyWrapperBuilder<B, BlockPropertyWrapperBuilder<B>, BlockPropertyWrapper<B>>> builderFactory, String modId) {
    ...
    public BlockPropertyWrapper(@NotNull Supplier<B> parentObject, Function<BlockPropertyWrapper<B>, PropertyWrapperBuilder<B, BlockPropertyWrapperBuilder<B>, BlockPropertyWrapper<B>>> builderFactory, String modId) {
    ...
    public BlockPropertyWrapper(Function<BlockPropertyWrapper<B>, PropertyWrapperBuilder<B, BlockPropertyWrapperBuilder<B>, BlockPropertyWrapper<B>>> builderFactory) {
