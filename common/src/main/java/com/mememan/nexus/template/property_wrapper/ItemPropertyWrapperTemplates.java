...
public final class ItemPropertyWrapperTemplates {
    ...
    public static final ItemPropertyWrapper<Item> MATERIAL = new ItemPropertyWrapper<>()
            ...
            .build();
    public static final ItemPropertyWrapper<Item> MATERIAL_PIECE = new ItemPropertyWrapper<>()
            .builder()
            .copyFrom(BASIC_GENERATED)
            .withRecipe(RecipeUtil::materialPieceFrom)
            .build();

    public static final ItemPropertyWrapper<Item> BOAT = new ItemPropertyWrapper<>()
            .builder()
            .copyFrom(BASIC_GENERATED)
            .asDispensable(VanillaUtil::standardBoatDispenseBehavior)
            .withRecipe(RecipeUtil::woodenBoatFrom)
            .withTag(() -> ItemTags.BOATS)
            .build();
    public static final ItemPropertyWrapper<Item> CHEST_BOAT = new ItemPropertyWrapper<>()
            .builder()
            .copyFrom(BASIC_GENERATED)
            .asDispensable(VanillaUtil::standardChestBoatDispenseBehavior)
            .withRecipe(RecipeUtil::woodenChestBoatFrom)
            .withTag(() -> ItemTags.CHEST_BOATS)
            .build();
     ...
     * @param itemId The target {@linkplain Item Item's} {@linkplain ResourceLocation registry ID}.
     * @param itemSup The {@link Item} object to register.
     * @param templateIPW The {@link ItemPropertyWrapper} template to inherit from.
     * @param itemSupCol An optional {@link Collection} to track the registered {@link Item}. Primarily useful if you
     *                   want a shorthand method of tracking your own registered items.
     *
     * @return The {@link Supplier} of the registered {@link Item}, mapped to its own {@link ItemPropertyWrapper}
     * inheriting from the provided {@code templateIPW}.
     *
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> Supplier<I> registerItemFromTemplate(ResourceLocation itemId, Supplier<I> itemSup, ItemPropertyWrapper<Item> templateIPW, @Nullable Collection<Supplier<Item>> itemSupCol) {
     ...
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> Supplier<I> registerItemFromTemplate(ResourceLocation itemId, Supplier<I> itemSup, ItemPropertyWrapper<Item> templateIPW) {
        return registerItemFromTemplate(itemId, itemSup, templateIPW, null);
    }

    /**
     * Registers the provided {@link Item} and returns its {@link ItemPropertyWrapperBuilder} without inheriting from
     * a template. Optionally tracks the registered {@link Item} to a custom {@link Collection}.
     *
     * @param itemId The target {@linkplain Item Item's} {@linkplain ResourceLocation registry ID}.
     * @param itemSup The {@link Item} object to register.
     * @param itemSupCol An optional {@link Collection} to track the registered {@link Item}. Primarily useful if you
     *                   want a shorthand method of tracking your own registered items.
     *
     * @return The {@link ItemPropertyWrapperBuilder} of the registered {@link Item}.
     *
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> ItemPropertyWrapperBuilder<I> registerAndChain(ResourceLocation itemId, Supplier<I> itemSup, @Nullable Collection<Supplier<Item>> itemSupCol) {
        Supplier<I> registeredItem = registerItem(itemId, itemSup, itemSupCol);
     ...
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> ItemPropertyWrapperBuilder<I> registerAndChain(ResourceLocation itemId, Supplier<I> itemSup) {
        return registerAndChain(itemId, itemSup, (Collection<Supplier<Item>>) null);
    }
     ...
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> ItemPropertyWrapperBuilder<I> registerAndChain(ResourceLocation itemId, Supplier<I> itemSup, ItemPropertyWrapper<Item> templateIPW, @Nullable Collection<Supplier<Item>> itemSupCol) {
        Supplier<I> registeredItem = registerItem(itemId, itemSup, itemSupCol);
     ...
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> ItemPropertyWrapperBuilder<I> registerAndChain(ResourceLocation itemId, Supplier<I> itemSup, ItemPropertyWrapper<Item> templateIPW) {
        return registerAndChain(itemId, itemSup, templateIPW, null);
    }
    ...
    public static <I extends Item> Supplier<I> registerItemAndReflect(ResourceLocation itemId, Supplier<I> itemSup, @Nullable Collection<Supplier<Item>> itemSupCol) {
        Supplier<I> registeredItem = NexusServices.REGISTRAR.registerObjectAndReflect(itemId, itemSup, BuiltInRegistries.ITEM);
    ...
    /**
     * Overloaded variant of {@link #registerItemAndReflect(ResourceLocation, Supplier, Collection)} that does not track the
     * registered {@link Item} to any custom {@link Collection}.
     *
     * @param itemId The target {@linkplain Item Item's} {@linkplain ResourceLocation registry ID}.
     * @param itemSup The {@link Item} object to register.
    ...
    public static <I extends Item> Supplier<I> registerItemAndReflect(ResourceLocation itemId, Supplier<I> itemSup) {
        return registerItemAndReflect(itemId, itemSup, null);
    }
     ...
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> Supplier<I> registerItemFromTemplateAndReflect(ResourceLocation itemId, Supplier<I> itemSup, ItemPropertyWrapper<Item> templateIPW, @Nullable Collection<Supplier<Item>> itemSupCol) {
        Supplier<I> registeredItem = registerItemAndReflect(itemId, itemSup, itemSupCol);
    ...
    /**
     * Overloaded variant of {@link #registerItemFromTemplateAndReflect(ResourceLocation, Supplier, ItemPropertyWrapper, Collection)}
     * that does not track the registered {@link Item} to any custom {@link Collection}.
     *
     * @param itemId The target {@linkplain Item Item's} {@linkplain ResourceLocation registry ID}.
     * @param itemSup The {@link Item} object to register.
     ...
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> Supplier<I> registerItemFromTemplateAndReflect(ResourceLocation itemId, Supplier<I> itemSup, ItemPropertyWrapper<Item> templateIPW) {
        return registerItemFromTemplateAndReflect(itemId, itemSup, templateIPW, null);
    }
     ...
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> ItemPropertyWrapperBuilder<I> registerAndReflectAndChain(ResourceLocation itemId, Supplier<I> itemSup, ItemPropertyWrapper<Item> templateIPW, @Nullable Collection<Supplier<Item>> itemSupCol) {
        Supplier<I> registeredItem = registerItemAndReflect(itemId, itemSup, itemSupCol);
    ...
    /**
     * Overloaded variant of {@link #registerAndReflectAndChain(ResourceLocation, Supplier, ItemPropertyWrapper, Collection)} that
     * does not track the registered {@link Item} to any custom {@link Collection}.
     *
     * @param itemId The target {@linkplain Item Item's} {@linkplain ResourceLocation registry ID}.
     * @param itemSup The {@link Item} object to register.
     ...
     * @param <I> Any {@link Item} type.
     */
    public static <I extends Item> ItemPropertyWrapperBuilder<I> registerAndReflectAndChain(ResourceLocation itemId, Supplier<I> itemSup, ItemPropertyWrapper<Item> templateIPW) {
        return registerAndReflectAndChain(itemId, itemSup, templateIPW, null);
    }

    /**
     * Registers and returns the provided {@link Item}, mapped to a new {@link ItemPropertyWrapper}
     * inheriting from the {@link #BASIC_GENERATED} template. Optionally tracks the registered {@link Item} to a
     * custom {@link Collection}.
     * <br></br>
     * Uses {@link Registrar#registerObjectAndReflect(ResourceLocation, Supplier, Registry)} instead of
     * {@link Registrar#registerObject(ResourceLocation, Supplier, Registry)}.
    ...
    public static <I extends Item> Supplier<I> registerBasicItemAndReflect(ResourceLocation itemId, Supplier<I> itemSup, @Nullable Collection<Supplier<Item>> itemSupCol) {
        return registerItemFromTemplateAndReflect(itemId, itemSup, BASIC_GENERATED, itemSupCol);
    }

    /**
     * Overloaded variant of {@link #registerBasicItemAndReflect(ResourceLocation, Supplier, Collection)} that does not track the
     * registered {@link Item} to any custom {@link Collection}.
     *
     * @param itemId The target {@linkplain Item Item's} {@linkplain ResourceLocation registry ID}.
     * @param itemSup The {@link Item} object to register.
    ...
    public static <I extends Item> Supplier<I> registerBasicItemAndReflect(ResourceLocation itemId, Supplier<I> itemSup) {
        return registerBasicItemAndReflect(itemId, itemSup, null);
    }
    ...
    public static Supplier<Item> registerBasicItemAndReflect(ResourceLocation itemId) {
        return registerBasicItemAndReflect(itemId, () -> new Item(new Item.Properties()));
    }

    /**
     * Registers and returns the provided {@link Item}, mapped to a new {@link ItemPropertyWrapper}
     * inheriting from the {@link #BASIC_HANDHELD} template. Optionally tracks the registered {@link Item} to a
     * custom {@link Collection}.
     * <br></br>
     * Uses {@link Registrar#registerObjectAndReflect(ResourceLocation, Supplier, Registry)} instead of
     * {@link Registrar#registerObject(ResourceLocation, Supplier, Registry)}.
    ...
    public static <I extends Item> Supplier<I> registerBasicHandheldItemAndReflect(ResourceLocation itemId, Supplier<I> itemSup, @Nullable Collection<Supplier<Item>> itemSupCol) {
        return registerItemFromTemplateAndReflect(itemId, itemSup, BASIC_HANDHELD, itemSupCol);
    }

    /**
     * Overloaded variant of {@link #registerBasicHandheldItemAndReflect(ResourceLocation, Supplier, Collection)} that does not
     * track the registered {@link Item} to any custom {@link Collection}.
     *
     * @param itemId The target {@linkplain Item Item's} {@linkplain ResourceLocation registry ID}.
     * @param itemSup The {@link Item} object to register.
    ...
    public static <I extends Item> Supplier<I> registerBasicHandheldItemAndReflect(ResourceLocation itemId, Supplier<I> itemSup) {
        return registerBasicHandheldItemAndReflect(itemId, itemSup, null);
    }
    ...
    public static Supplier<Item> registerBasicHandheldItemAndReflect(ResourceLocation itemId) {
        return registerBasicHandheldItemAndReflect(itemId, () -> new Item(new Item.Properties()));
    }
}
