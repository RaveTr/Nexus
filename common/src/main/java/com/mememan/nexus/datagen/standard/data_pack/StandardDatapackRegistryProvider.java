...
public class StandardDatapackRegistryProvider extends RegistriesDatapackGenerator implements ModDataProvider {
     ...
     */
    @Override
    public <T> @NotNull Optional<CompletableFuture<?>> dumpRegistryCap(CachedOutput cachedOutput, HolderLookup.Provider regProvider, DynamicOps<JsonElement> encoderOps, RegistryDataLoader.RegistryData<T> regData) {
